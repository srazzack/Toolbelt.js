describe("Toolbelt", function () {
    ...
    describe("toolbelt array function compact standard tests", function () {
        it("should return [1,2,3,4,5,6]", function () {
            expect(Toolbelt.array.flatten([1, 2, [3, 4, [5]],
                [3]
            ])).toEqual([1, 2, 3, 4, 5, 3]);
        });
        it("should return [1,4b,2,3,4,54t]", function () {
            expect(Toolbelt.array.flatten([1, ["4b", [
                [2, 3], 4], "54t"]])).toEqual([1, "4b", 2, 3, 4, "54t"]);
        });
    });
    describe("toolbelt array function compact standard tests", function () {
        it("should return [1,2,3,4,5,6]", function () {
            expect(Toolbelt.array.flatten([1, 2, [3, 4, [5]],
                [3]
            ])).toEqual(_.flatten([1, 2, [3, 4, [5]],
                [3]
            ]));
        });
        it("should return [1,4b,2,3,4,54t]", function () {
            expect(Toolbelt.array.flatten([1, ["4b", [
                [2, 3], 4], "54t"]])).toEqual(_.flatten([1, ["4b", [
                [2, 3], 4], "54t"]]));
        });
    });
    describe("toolbelt array function compact standard tests", function () {
    ...
    describe("toolbelt array function zip", function () {
        it("should return [1,2,3,4]", function () {
            expect(Toolbelt.array.zip([1, 2, 3], [1, 2, 3], [1, 2, 3])).toEqual([
                [1, 1, 1],
                [2, 2, 2],
                [3, 3, 3]
            ]);
        ...
        it("should get rid of duplicates", function () {
            expect(Toolbelt.array.zip(['moe', 'larry', 'curly'], [30, 40, 50], [true, false, false])).toEqual([
                ["moe", 30, true],
                ["larry", 40, false],
                ["curly", 50, false]
            ]);
    ...
    describe("Toolbelt array function unique should return the same as underscore's uniq function", function () {
        ...
        it("should return the same as underscores difference", function () {
            expect(Toolbelt.array.zip([1, 2, 54], [2, 4, 56], [
                [2], 3, 7])).toEqual(_.zip([1, 2, 54], [2, 4, 56], [
                [2], 3, 7]));
        });
    });
    describe("Toolbelt object function should return the same as the underscore object function", function () {
        ...
        it("should return object", function () {
            expect(Toolbelt.array.object(['moe', 'larry', 'curly'], [30, 40, 50])).toEqual({
                'moe': 30,
                'larry': 40,
                'curly': 50
            });
    ...
    describe("function should return object", function () {
        it("should return object", function () {
            expect(Toolbelt.array.object(['moe', 'larry', 'curly'], [30, 40, 50])).toEqual(_.object([
                ['moe', 30],
                ['larry', 40],
                ['curly', 50]
            ]));
